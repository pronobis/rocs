...
if(ROCS_FIND_BOOST_HEADERS)
	...
	if(NOT Boost_FOUND)
		message(FATAL_ERROR "Header files of the Boost library version >=1.40.0 not found.")
	endif(NOT Boost_FOUND)
	message(STATUS "Found header files of the Boost library version ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION}.")
...
if(ROCS_FIND_BOOST_PROPERTY_TREE)
	...
	if(NOT Boost_FOUND)
		message(FATAL_ERROR "Boost property_tree library version >=1.41.0 not found.")
	else(NOT Boost_FOUND)
		message(STATUS "Found Boost property_tree library version ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION}.")
...
if(ROCS_FIND_BOOST_PROGRAM_OPTIONS)
	...
	if(NOT Boost_FOUND)
		message(FATAL_ERROR "Boost program_options library version >=1.40.0 not found.")
	endif(NOT Boost_FOUND)
	message(STATUS "Found Boost program_options library version ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION}.")
...
if(ROCS_FIND_BOOST_SYSTEM)
	...
	if(NOT Boost_FOUND)
		message(FATAL_ERROR "Boost system library version >=1.40.0 not found.")
	endif(NOT Boost_FOUND)
	message(STATUS "Found Boost system library version ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION}.")
...
if(ROCS_FIND_BOOST_FILESYSTEM)
	...
	if(NOT Boost_FOUND)
		message(FATAL_ERROR "Boost filesystem library version >=1.40.0 not found.")
	endif(NOT Boost_FOUND)
	message(STATUS "Found  Boost filesystem library version ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION}.")
...
if(ROCS_FIND_BOOST_UNIT_TEST_FRAMEWORK)
	...
	if(NOT Boost_FOUND)
		message(FATAL_ERROR "Boost unit_test_framework library version 1.40.0 not found.")
	endif(NOT Boost_FOUND)
	message(STATUS "Found Boost unit_test_framework library version ${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION}.")
